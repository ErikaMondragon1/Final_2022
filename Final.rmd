...
On the chi-squared test the p-value is  0.0000000000001098, which is less than 0.05 so we reject the null hypothesis. On the fisher test, the p-value is 0.00000000000004631, we reject the null hypothesis, which is, the covid921 vaccine does not exhibit a significant difference in effectiveness between male populations. The odds ratio shows that you are 2 times more likely to get of covid if you are male and dont get the vaccine
...
Since the p-value for the chi-squared test is 0.00000006668, which is less than 0.05, we may reject the null hypothesis. With a p-value of 0.0000000109 on the Fisher test, we reject the null hypothesis, therefore,The covid921 vaccine does not exhibit a significant difference in effectiveness between LGBTQ populations. The odds ratio, those who do receive the vaccination have a 0.181 times increased risk of contracting COVID-19.
